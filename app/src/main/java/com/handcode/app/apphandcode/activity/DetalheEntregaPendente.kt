...
class DetalheEntregaPendente : DebugActivity() {

    private val context: Context get() = this
    var entrega: Entrega? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.entrega_pendente_activity)
        ...
        var buttonEntregar = findViewById<TextView>(R.id.btEntregar)
    ...
    private fun entregar() {
        if (this.entrega != null && this.entrega is Entrega) {
            ...
            Thread {
                EntregaService.entregar(this.entrega as Entrega, context)
                runOnUiThread {
